...
function conection(status) {
   ...
   // Tu código:
   estado = status;
   if(estado == 1)return("Online");
   else if(estado == 2)return("Away");
   else return("Offline");
}
...
function saludo(idioma) {
   ...
   // Tu código:
   lenguaje = idioma;
   if(lenguaje === "aleman")return("Guten Tag!");
   else if(lenguaje === "mandarin")return("Ni Hao!");
   else if(lenguaje === "ingles")return("Hello!");
   else return("Hola!");
}
...
function estaEnRango(num) {
   ...
   // Tu código:
   numero1 = num;
   if(numero1 < 50 && numero1 > 20)return(true);
   else return(false);
}
...
function fizzBuzz(num) {
   ...
   // Tu código:
   numero3 = num;
   if(numero3 % 3 == 0 && numero3 % 5 == 0)return("fizzbuzz");
   else if(numero3 % 3 == 0)return("fizz");
   else if(numero3 % 5 == 0)return("buzz");
   else return(false);
}
